...
| DAP debug adapters | Mason | Mason | `:DapInstallAdapters` installs the three adapters declared in `lua/pcf/plugins/debugging/dap.lua`; see `docs/strategy.md` for why Mason and not Nix here |
